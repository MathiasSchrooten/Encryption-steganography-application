...
class Ambiance_Button_1 : Control
{
    ...
    protected override void OnResize(System.EventArgs e)
    {
        if (Width > 0 && Height > 0)
        {
            ...
            PressedContourGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(244, 146, 106), Color.FromArgb(244, 146, 106), 90f);
...
class Ambiance_LinkLabel : LinkLabel
{
    public Ambiance_LinkLabel()
    {
        ...
        BackColor = Color.Transparent;
        LinkColor = Color.FromArgb(244, 146, 106);
        ActiveLinkColor = Color.FromArgb(244, 146, 106);
        VisitedLinkColor = Color.FromArgb(244, 146, 106);
...
class Ambiance_TextBox : Control
{
    ...
    public Ambiance_TextBox()
    {
        ...
        P1 = new Pen(Color.FromArgb(244, 146, 106)); // P1 = Border color
...
public class Ambiance_ListBox : ListBox
{
    ...
    protected override void OnDrawItem(DrawItemEventArgs e)
    {
        base.OnDrawItem(e);
        e.DrawBackground();
        LinearGradientBrush LGB = new LinearGradientBrush(e.Bounds, Color.FromArgb(244, 146, 106), Color.FromArgb(244, 146, 106), 90.0F);
        if (System.Convert.ToInt32((e.State & DrawItemState.Selected)) == (int)DrawItemState.Selected)
        {
            e.Graphics.FillRectangle(LGB, e.Bounds);
        }
...
[DefaultEvent("ToggledChanged")]
public class Ambiance_AB : Control
{
    ...
    protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
    {
        ...
        switch (ToggleType)
        {
            case _Type.AB:
                if (Toggled)
                {
                    G.DrawString("A", new Font("Segoe UI", 12, FontStyle.Regular), Brushes.WhiteSmoke, Bar.X + 18, (float)(Bar.Y + 13.5), new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center });
                }
                else
                {
                    G.DrawString("B", new Font("Segoe UI", 12, FontStyle.Regular), Brushes.WhiteSmoke, Bar.X + 59, (float)(Bar.Y + 13.5), new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center });
                    //G.DrawString("B", new Font("Segoe UI", 12, FontStyle.Regular), Brushes.DimGray, Bar.X + 59, (float)(Bar.Y + 13.5), new StringFormat() { Alignment = StringAlignment.Center, LineAlignment = StringAlignment.Center });
                }
                break;
        }
